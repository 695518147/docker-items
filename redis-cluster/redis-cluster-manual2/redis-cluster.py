...
if __name__ == "__main__":
    ...
    # redis集群节点
    startup_nodes = [
        {'host': '192.168.0.100', 'port': 5379},
        {'host': '192.168.0.100', 'port': 5380},
        {'host': '192.168.0.100', 'port': 5381},
        {'host': '192.168.0.100', 'port': 5382},
        {'host': '192.168.0.100', 'port': 5383},
        {'host': '192.168.0.100', 'port': 5384}]
    # 构建连接池
